...
interface PostgreSQLConnectionModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: (connection: any) => void;
}

export const PostgreSQLConnectionModal: React.FC<
  PostgreSQLConnectionModalProps
> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      toast.loading("Creating PostgreSQL connection...", {
        id: "create-connection",
      });

      // Call backend API to create PostgreSQL connection
      const newConnection = await apiService.createPostgreSQLConnection(
        formData
      );
      ...
      toast.error(err.message || "Failed to create PostgreSQL connection", {
        id: "create-connection",
      });
    }
  };
