...
| Frontend (Docker) | 8080/8443 | Nginx → `databridge-frontend` container |
| Backend (Docker) | 3002 | NestJS → `databridge-backend` container |
| MySQL | 3308 | `databridge-mysql` container |
| Redis | 6381 | `databridge-redis` container |
